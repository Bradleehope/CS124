...
* Print out story
*/
void displayStory (char fileName[], char word[][30])
{
   int x = 0;   
   string madlib[1024];   
   int i = 0;
   ...
   for (i = 0; i < k; i++) 
   {
      ...
      if (madlib[i][1] == '{' || madlib[i][1] == '[' )
      {
      }
      else if (madlib[j][0] >= 65 && madlib[i][1] != 35)
      {
         if (madlib[i][1] != '#')        
         {
            cout << " ";
